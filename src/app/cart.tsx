...
export default function Cart() {
  ...
  try {
    ...
    if (!result) {
      // This means the user cancelled the Stripe payment sheet
      Alert.alert('Payment Cancelled', 'You closed the payment screen before completing the payment.');
      return;
    }
    ...
    // Specific error if the user canceled from within Stripe UI
